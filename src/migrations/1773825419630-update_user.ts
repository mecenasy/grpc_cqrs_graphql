...
export class UpdateUser1773825419630 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "users" ADD "surname" character varying(60) NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD "street" character varying(60) NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD "zip_code" character varying(60) NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD "street_number" character varying(60) NOT NULL`,
    );
  }
